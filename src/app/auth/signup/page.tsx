    ...
    return (
      <div className="min-h-screen bg-[#0a0e1a] flex items-center justify-center p-6">
        <div className="w-full max-w-[820px] flex rounded-2xl overflow-hidden border border-[#151d35]" style={{minHeight:"500px"}}>
          <div className="flex-1 bg-[#070b16] border-r border-[#151d35] flex flex-col justify-center px-10">
          ...
          <div className="w-[300px] bg-[#0a0e1a] flex flex-col justify-center px-8 text-center">
            <div className="w-12 h-12 rounded-xl bg-[#0f1e4a] border border-[#1e2a50] flex items-center justify-center mx-auto mb-4">
              <svg className="w-6 h-6 text-[#60a5fa]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7"/></svg>
            </div>
            <h3 className="text-[16px] font-bold text-white mb-2">Check your email</h3>
            <p className="text-[12px] text-[#2a3560] mb-6 leading-relaxed">We sent a link to <span className="text-[#60a5fa]">{email}</span></p>
    ...
    <div className="min-h-screen bg-[#0a0e1a] flex items-center justify-center p-6">
      <div className="w-full max-w-[820px] flex rounded-2xl overflow-hidden border border-[#151d35]" style={{minHeight:"500px"}}>
        <div className="flex-1 bg-[#070b16] border-r border-[#151d35] flex flex-col justify-center px-10">
          ...
          <p className="text-[13px] text-[#2a3560]">Start logging trips for free</p>
        </div>
        <div className="w-[300px] bg-[#0a0e1a] flex flex-col justify-center px-8">
          <h3 className="text-[18px] font-bold text-white mb-1">Get started</h3>
          <p className="text-[12px] text-[#2a3560] mb-7">Create your free driver account</p>
          <form onSubmit={handleSignup} className="flex flex-col gap-3">
            <div>
              <label className="block text-[11px] font-semibold text-[#2a3560] uppercase tracking-widest mb-2">Full Name</label>
          ...
          <p className="text-center text-[12px] text-[#1e2a50] mt-5">
            Already have one?{" "}
            <Link href="/auth/login" className="text-[#60a5fa] hover:text-[#93c5fd]">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
