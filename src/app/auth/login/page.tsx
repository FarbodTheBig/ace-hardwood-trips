    ...
    <div className="min-h-screen bg-[#eef2f7] flex items-center justify-center p-6">
      <div className="w-full max-w-[820px] flex rounded-2xl overflow-hidden border border-[#d8e0ec] shadow-sm" style={{minHeight:"500px"}}>
        ...
        <div className="w-[300px] bg-white flex flex-col justify-center px-8">
          <h3 className="text-[18px] font-bold text-[#0f1a35] mb-1">Sign in</h3>
          <p className="text-[12px] text-[#94a3b8] mb-7">Welcome back to RoadLog</p>
          ...
          <p className="text-center text-[12px] text-[#94a3b8] mt-5">
            New to RoadLog?{" "}
            <Link href="/auth/signup" className="text-[#2563eb] hover:text-[#1d4ed8]">Create account</Link>
          </p>
          <Link href="/admin/login" className="block text-center text-[11px] text-[#cbd5e1] hover:text-[#94a3b8] transition-colors mt-6">
            Admin access →
          </Link>
        </div>
      </div>
